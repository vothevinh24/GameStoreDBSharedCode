    ...
    return function(t) {
        ...
        class pl {
            ...
            revert(t) {
                ...
                yield* function* t(e) {
                    if (e.children)
                        for (const n of e.children) El(n) ? yield n: Sl(n) && (yield* t(n))
                }(this)
            }
            static bind(t, e) {
                return {
            ...
            _renderElementChildren(t) {
                ...
                for (const r of this.children)
                    ...
                    } else if (El(r)) i || (r.isRendered || r.render(), n.appendChild(r.element));
            ...
            if ("string" == typeof t ? t = function(t) {
                ...
                if (t.children)
                    if (Il(t.children)) e.push(t.children);
                        ...
                        for (const n of t.children) Sl(n) || El(n) || Zo(n) ? e.push(n) : e.push(new pl(n));
                t.children = e
            }
            return t
        }
        ...
        function Id(t, e, n) {
            ...
            for (; s < t.length;) {
                ...
                const a = e[o],
                    c = Sd(n, a, r.getContext(n, a, !0)),
                    l = Sd(a, n, r.getContext(a, n, !1));
        ...
        class Tu extends Xl {
            ...
            execute() {
                ...
                t.change(t => {
                    if (this.value) this._removeQuote(t, i.filter(Pu));
                    else {
        ...
        class pf extends Gl {
            ...
            init() {
                ...
                }), t.commands.add("imageUpload", new ff(t)), i.for("upcast").attributeToAttribute({
                    view: {
                        name: "img",
                        key: "uploadId"
                    },
        ...
        class Cf extends Gl {
            ...
            init() {
                const t = this.editor,
                    ...
                    n = [];
                for (const i of e) i.model !== Af && (t.model.schema.register(i.model, {
                    inheritAllFrom: "$block"
        ...
        class If extends Wd {
            ...
            _createArrowView() {
                const t = new Hd;
                return t.content = Sf.a, t.extendTemplate({
                    attributes: {
        ...
        function Lf(t, e = If) {
            const n = new e(t),
                i = new Pf(t),
                o = new Mf(t, n, i);
            return n.bind("isEnabled").to(o), n instanceof If ? n.bind("isOn").to(o, "isOpen") : n.arrowView.bind("isOn").to(o, "isOpen"),
                function(t) {
                    (function(t) {
                        t.on("render", () => {
                            Ch({
        ...
        class Ff extends Gl {
            init() {
                ...
                o.downcastDispatcher.on("insert:caption", Uf(s)), o.downcastDispatcher.on("insert", this._fixCaptionVisibility(t => t.item), {
                    priority: "high"
            ...
            _insertMissingModelCaptionElement(t) {
                ...
                for (const t of n)
                    if ("insert" == t.type && "$text" != t.name) {
                        ...
                        if (n.is("image") && !Bf(n) && i.push(n), !n.is("image") && n.childCount)
                            for (const t of e.createRangeIn(n).getItems()) t.is("image") && !Bf(t) && i.push(t)
        ...
        class sm extends Gl {
            ...
            init() {
                ...
                const r = function(t) {
                    return (e, n, i) => {
                        if (!i.consumable.consume(n.item, e.name)) return;
                        const o = $f(n.attributeNewValue, t),
                ...
                i.downcastDispatcher.on("attribute:imageStyle:image", r), n.downcastDispatcher.on("attribute:imageStyle:image", r), n.upcastDispatcher.on("element:figure", function(t) {
                    ...
                    priority: "low"
                }), t.commands.add("imageStyle", new Yf(t, o))
            }
        }
        n(97);
        class am extends Gl {
        ...
        class Ap extends Gl {
            ...
            init() {
                ...
                }), i.for("editingDowncast").add(fp(r, {
                    renderForEditingView: !0
                })), i.for("upcast").elementToElement({
                    view: {
                        name: "oembed",
            ...
            return e => e.on("insert:table", (e, n, i) => {
                ...
                for (const e of l) {
                    const {
                        row: n,
                        cell: r
                    } = e, s = og(ig(n, d), a, i), c = o.getChild(n), l = u.get(n) || eg(c, n, s, i);
        ...
        function Gp(t = {}) {
            return e => e.on("insert:tableRow", (e, n, i) => {
                ...
                const r = o.parent,
                    ...
                    d = new Map;
                for (const e of c) {
                    const n = og(ig(a, l), s, i),
                        r = d.get(a) || eg(o, a, n, i);
        ...
        class dg extends Xl {
            ...
            execute() {
                const t = this.editor,
                    ...
                    i = jp("tableCell", e.getFirstPosition()).parent,
                    o = i.parent,
                    r = o.getChildIndex(i),
        ...
        class fg extends Xl {
            ...
            execute() {
                const t = this.editor.model,
                    e = jp("tableCell", t.document.selection.getFirstPosition()),
                    n = this.value,
                    i = this.direction;
                t.change(t => {
        ...
        class pg extends Xl {
            ...
            execute() {
                const t = this.editor.model,
                    e = jp("tableCell", t.document.selection.getFirstPosition()).parent,
                    n = e.parent,
                    i = n.getChildIndex(e),
            ...
            execute() {
                ...
                t.change(t => {
                    ...
                    for (const {
                            ...
                            column: n,
                            colspan: i
                        } of s) n <= a && i > 1 && n + i > a ? Vp("colspan", i - 1, e, t) : n === a && t.remove(e)
                })
            }
        }
        class bg extends Xl {
        ...
        class Lg extends Gl {
            init() {
                ...
                n.register("table", {
                    ...
                    asWidget: !0
                })), i.for("dataDowncast").add($p()), i.for("upcast").elementToElement({
                    model: "tableRow",
                    view: "tr"
                    ...
                    priority: "higher"
                })), i.for("upcast").add(Fp("td")), i.for("upcast").add(Fp("th")), i.for("editingDowncast").add(Qp({
                    asWidget: !0
                    ...
                    asWidget: !0
                })), i.for("dataDowncast").add(Jp()), Ng(t.model, t.editing), t.commands.add("insertTable", new lg(t)), t.commands.add("insertTableRowAbove", new dg(t, {
                    order: "above"
                })), t.commands.add("insertTableRowBelow", new dg(t, {
                    order: "below"
                })), t.commands.add("insertTableColumnLeft", new ug(t, {
                    order: "left"
                })), t.commands.add("insertTableColumnRight", new ug(t, {
                    order: "right"
                })), t.commands.add("removeTableRow", new pg(t)), t.commands.add("removeTableColumn", new gg(t)), t.commands.add("splitTableCellVertically", new hg(t, {
                    direction: "vertically"
                })), t.commands.add("splitTableCellHorizontally", new hg(t, {
                    direction: "horizontally"
                })), t.commands.add("mergeTableCellRight", new fg(t, {
                    direction: "right"
                })), t.commands.add("mergeTableCellLeft", new fg(t, {
                    direction: "left"
                })), t.commands.add("mergeTableCellDown", new fg(t, {
                    direction: "down"
                })), t.commands.add("mergeTableCellUp", new fg(t, {
                    direction: "up"
                })), t.commands.add("setTableColumnHeader", new _g(t)), t.commands.add("setTableRowHeader", new bg(t)), Ag(e), Mg(e), this.editor.keystrokes.set("Tab", (...t) => this._handleTabOnSelectedTable(...t), {
                    priority: "low"
        ...
        function Gg(t, e, n, i) {
            const o = t.model = new Tf(t.model),
                {
                    commandName: r,
                    bindIsOn: s
                } = t.model;
